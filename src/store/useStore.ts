      ...
      merge: (persisted, current) => {
        ...
        return {
          ...
          user: {
            ...
            savedPosts: arr(pu.savedPosts, base.savedPosts),
            followedSellerIds: arr(pu.followedSellerIds, base.followedSellerIds),
            recentProductIds: arr(pu.recentProductIds, base.recentProductIds),
            recentPostIds: arr(pu.recentPostIds, base.recentPostIds),
            whatsappClicks: arr(pu.whatsappClicks, base.whatsappClicks),
